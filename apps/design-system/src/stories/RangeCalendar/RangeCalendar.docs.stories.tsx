...
import type { RangePreset } from '../../components/RangeCalendar'
  ...
  render: () => (
    <DocPage>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <CodeBlock>{`import { RangeCalendar } from '@port/design-system'
import type { RangePreset } from '@port/design-system'`}</CodeBlock>
      </div>
