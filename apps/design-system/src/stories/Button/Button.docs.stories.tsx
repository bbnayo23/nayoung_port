...
import { XdrPlusIcon, XdrArrowRightIcon, XdrDownloadIcon } from '@port/icon-library'
    ...
    return (
      <DocPage>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <CodeBlock>{`import { Button } from '@port/design-system'`}</CodeBlock>
        </div>
            ...
            <PropsTable
              rows={[
                ...
                },
                {
                  ...
                  type: "'sm' | 'md' | 'lg'",
                  defaultVal: "'md'",
                  desc: '버튼 크기 — sm(h28) · md(h32) · lg(h36)',
                },
                {
                  name: 'loading',
                  type: 'boolean',
                ...
                { name: 'fullWidth', type: 'boolean', defaultVal: 'false', desc: '부모 컨테이너 너비에 맞춥니다.' },
                {
                  ...
                  type: 'boolean',
                  defaultVal: 'false',
                  desc: '비활성 상태 — opacity 0.4, pointer-events none',
                },
              ...
              {SIZES.map((s) => (
                <div key={s} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                  ...
                  <code style={{ fontSize: 10, color: t.textMuted, fontFamily: 'monospace' }}>
                    {s === 'sm' ? 'h-28 · 11px' : s === 'md' ? 'h-32 · 12px' : 'h-36 · 16px'}
                  </code>
                </div>
              ))}
            </div>
          ...
          <Card>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
              {[
                ...
                { label: 'Active', props: { className: 'is-active' } },
        ...
        <Section gap={16}>
          ...
          <CodeBlock>{`import { XdrPlusIcon } from '@port/icon-library'

<Button leftIcon={<XdrPlusIcon />}>추가</Button>
<Button rightIcon={<XdrArrowRightIcon />} variant="outline">다음</Button>`}</CodeBlock>
          <Card>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
              <Button leftIcon={<XdrPlusIcon />}>추가</Button>
              ...
              <Button leftIcon={<XdrPlusIcon />} variant="ghost" size="sm">
                ghost sm
              </Button>
            </div>
          </Card>
